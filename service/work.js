...
const printer = new PdfPrinter(fonts);
  ...
  app.post("/work/load", upload.none(), function (req, res) {
   ...
   app.post("/work/ApproveOrReject", upload.none(),function (req, res) {
    ...
    connection
      ...
      var workbook = excelbuilder.createWorkbook('./uploads/Excel/', 'WorkList'  + '.xlsx')
      var sheet1 = workbook.createSheet('Sheet', 6, works.length + 1);
        ...
        sheet1.border(2, 1, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
        sheet1.border(3, 1, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
        sheet1.border(4, 1, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
        sheet1.border(5, 1, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
        ...
        for (var j = 0; j < works.length; j++) {
            ...
            sheet1.border(1, j + 2, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
            sheet1.border(2, j + 2, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
            sheet1.border(3, j + 2, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
            sheet1.border(4, j + 2, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
            sheet1.border(5, j + 2, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
 ...
 var data = result.recordsets[0]
                        ...
                        Header1.push({ text: 'Title',   style: 'tableHeader', alignment: 'center' } )
                        Header1.push({ text: 'Description',   style: 'tableHeader', alignment: 'center' })
                        Header1.push({ text: 'Client',   style: 'tableHeader', alignment: 'center' })
                        Header1.push({ text: 'Drive Link',   style: 'tableHeader', alignment: 'center' })
                        Header1.push({ text: 'Status',   style: 'tableHeader', alignment: 'center' })
                        ...
                        var dd = {
                            ...
                            footer: {
                                columns: [
                                    { text: 'Powered By ', style: 'reportFooter', alignment: 'right' }
                                ]
                            },
                            content: [
                            //   {
                        ...
                        pdfDoc.pipe(fs.createWriteStream('uploads/PDF/works.pdf')).on('finish', function () {
                            //success
    ...
    connection
      ...
      var workbook = excelbuilder.createWorkbook('./uploads/Excel/', 'Ads'  + '.xlsx')
      var sheet1 = workbook.createSheet('Sheet', 6, works.length + 1);
        // Fill some data
        // sheet1.set('Code','Name','UOM','SystemStock','PhysicalStock','Variation');
        sheet1.set(1, 1, 'Ad');
        ...
        sheet1.border(4, 1, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
        sheet1.border(5, 1, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
        sheet1.border(6, 1, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
        ...
        for (var j = 0; j < works.length; j++) {
            ...
            sheet1.border(4, j + 2, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
            sheet1.border(5, j + 2, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
            sheet1.border(6, j + 2, { left: 'thin', top: 'thin', right: 'thin', bottom: 'thin' });
        }
 ...
 var data = result.recordsets[0]
                        ...
                        Header1.push({ text: 'Title',   style: 'tableHeader', alignment: 'center' } )
                        Header1.push({ text: 'Client',   style: 'tableHeader', alignment: 'center' })
                        Header1.push({ text: 'Date Period',   style: 'tableHeader', alignment: 'center' })
                        Header1.push({ text: 'Spend',   style: 'tableHeader', alignment: 'center' })
                        Header1.push({ text: 'No.of conversions',   style: 'tableHeader', alignment: 'center' })
                        Header1.push({ text: 'Revenue',   style: 'tableHeader', alignment: 'center' })
 
 
                        var head=['title','client','dateperiod','spend','count','Revenue']
                        var bodyData = [];
                        bodyData.push(Header1)
                        data.forEach(function (sourceRow) {
                            var dataRow = []
                        ...
                        var dd = {
                            ...
                            { text: 'Ads and Conversions', style: 'header', alignment: 'center' },
                        ...
                        var pdfDoc = printer.createPdfKitDocument(dd);
                        pdfDoc.pipe(fs.createWriteStream('uploads/PDF/ads.pdf')).on('finish', function () {
                            //success
                            console.log("create the file")
